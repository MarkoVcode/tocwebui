            ...
            {data.map((param: any, index: any) => (
                ...
                <div class="mx-auto max-w-md overflow-hidden rounded-lg bg-white shadow">
                    ...
                    <div class="p-4">
                        ...
                        <p class="mt-1 text-gray-500">{param.name} Sailboat UI is a modern UI component library for Tailwind CSS. Get started with 150+ open source components.</p>
