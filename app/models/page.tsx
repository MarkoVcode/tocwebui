        ...
        <>
            {data.map((param: any, index: any) => (
                ...
                <div className="mx-auto max-w-md overflow-hidden rounded-lg bg-white shadow">
                    <Image src="https://images.unsplash.com/photo-1552581234-26160f608093?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80" className="aspect-video w-full object-cover" alt="" />
                    <div className="p-4">
