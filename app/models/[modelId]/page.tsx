        ...
        <div className="flex flex-col h-full">
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-[300px_1fr] gap-8 p-6">
                <div className="space-y-6">
                    <ModelForm modelId={params.modelId} setModelLink={setModelLink} setModelParams={setModelParams} />
                </div>
                <div className="bg-muted rounded-lg overflow-hidden">
                    <ModelPreview modelId={params.modelId} modelLink={modelLink} />
                </div>
            </div>
            <div className="bg-background border-t px-6 py-4">
                <ModelExport modelId={params.modelId} paramsData={modelParams} />
            </div>
        </div>
    )
}
